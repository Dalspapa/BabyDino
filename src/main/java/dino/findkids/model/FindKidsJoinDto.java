...
public class FindKidsJoinDto {
	...
	public FindKidsJoinDto(String k_name, int idx, int k_gender, String k_tendency, String k_care_type,
			String k_require, String k_introduce, String addr1, String addr2, String addr3, int hope_cost,
			String r_time, Date r_endday, int r_cost, int d_kid_idx, int d_member_p_idx, String c_imgpath,
			String teacher_type, int star, Date r_writedate, String content) {
		super();
		this.k_name = k_name;
		this.idx = idx;
