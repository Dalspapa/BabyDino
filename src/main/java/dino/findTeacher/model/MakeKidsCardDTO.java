package dino.findTeacher.model;

import java.sql.Date;

public class MakeKidsCardDTO {
	...
	public MakeKidsCardDTO() {
		// TODO Auto-generated constructor stub
	}

	public MakeKidsCardDTO(int idx, int d_member_idx, String k_name, int k_gender, String k_tendency, Date k_birth,
