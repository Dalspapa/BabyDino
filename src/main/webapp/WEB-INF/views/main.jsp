	            ...
	            <div>
	              ...
	              <div class="row nori-imgs">
	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6" >
	                  <span class="nori-box " >
	                    <img src="./common/img/main1.jpg" alt="책읽기">
	                  </span>
	                </div>

	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6" >
	                  <span class="nori-box " >
	                    <img src="./common/img/main2.jpg" alt="책읽기">
	                  </span>
	                </div>
	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6" >
	                  <span class="nori-box " >
	                    <img src="./common/img/main3.jpg" alt="책읽기">
	                  </span>
	                </div>
	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6" >
	                  <span class="nori-box">
	                    <img src="./common/img/main4.jpg" alt="책읽기">
	                  </span>
	                </div>
	                ...
	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6" >
	                  ...
	                  <span class="nori-box">
	                    <img src="./common/img/main5.jpg" alt="책읽기">
	                  </span>
	                </div>
	                <div class="col-xxl-2 col-lg col-sm-6 col-xs-6">
	                  <span class="nori-box">
	    ...
	    <section id="section06" class="page-section-question">
	          <div class="container">
	              ...
	              <div class="row faq-imgs">
	                <div class="col-lg col-sm-4 col-xs text-center" style="MARGIN: -12px;">
	                  <span class="faq-box" >
	                    <img src="./common/img/놀이2.png" alt="아이공룡을 어떻게 믿죠?"><hr>
	                    <h4 class="text-muted">전문 1:1 놀이 돌봄</h4>
	                  </span>
	                </div>
	                <div class="col-lg col-sm-4 col-xs text-center">
	                  <span class="faq-box" >
	                    <img src="./common/img/놀이1.png" alt="부모님을 어떻게 믿죠?"><hr>
	                    <h4 class="text-muted">아이의 일상을 기록하는 성장노트</h4>
	                  </span>
	                </div>

	                <div class="col-lg col-sm-4 col-xs text-center" style="MARGIN: 3px;">
	                  <span class="faq-box">
	                    <img src="./common/img/놀이3.png" alt="아기공룡 멤버쉽은 무엇인가요?"><hr>
	                  </span>
