	...
	<div id="h_Div">
		...
		<div id="step_1">
			<h4>Q1. 부모님의 무리한 요구사항을 거절해야 할 때 어떻게 해야할까요?</h4>
				<p>
					<input type="radio" id="q_1_a" name="quiz" class="quiz" value="0"><label for="q_1_a">망설이지 말고 단호히 거절한다.</label><br>
					<input type="radio" id="q_1_b" name="quiz" class="quiz" value="0"><label for="q_1_b">바로 회사로 연락해 도움을 요청한다.</label><br>
					<input type="radio" id="q_1_c" name="quiz" class="quiz" value="1"><label for="q_1_c">죄송하지만 등의 쿠션언어를 사용해 정중하고 부드럽게 거절한다.</label><br>
					<input type="radio" id="q_1_d" name="quiz" class="quiz" value="0"><label for="q_1_d">거절이 어려우므로 그냥 일단 요청대로 한다.</label>
				</p>
			<div id="q_btn">
		...
		<div id="step_2" class="makeTdiv" style="width: 100%;">
			<h4>Q2. 돌봄 전날 몸이 아파요. 어떻게 해야할까요?</h4>
				<p>
					<input type="radio" id="q_2_a" name="quiz" class="quiz" value="1"><label for="q_2_a">부모님께 연락해 일정 조율을 해보고 안되면 회사로 연락 후 취소한다.</label><br>
					<input type="radio" id="q_2_b" name="quiz" class="quiz" value="0"><label for="q_2_b">약을 먹고 아침까지 기다려본다.</label><br>
					<input type="radio" id="q_2_c" name="quiz" class="quiz" value="0"><label for="q_2_c">바로 취소 버튼을 먼저 누른다.</label><br>
					<input type="radio" id="q_2_d" name="quiz" class="quiz" value="0"><label for="q_2_d">회사로 먼저 연락한다.</label>
				</p>
			<div id="q_btn">
		...
		<div id="step_3" class="makeTdiv" style="width: 100%;">
			<h4>Q3. 아이가 갑자기 놀이터로 나가자고 하면 어떻게 해야할까요?</h4>
				<p>
					<input type="radio" id="q_3_a" name="quiz" class="quiz" value="0"><label for="q_3_a">안된다고 단호하게 말하고 장소를 옮기지 않는다.</label><br>
					<input type="radio" id="q_3_b" name="quiz" class="quiz" value="0"><label for="q_3_b">아이가 원하므로 일단 간다.</label><br>
					<input type="radio" id="q_3_c" name="quiz" class="quiz" value="0"><label for="q_3_c">집으로 들어간다.</label><br>
					<input type="radio" id="q_3_d" name="quiz" class="quiz" value="1"><label for="q_3_d">부모님께 연락드려 장소를 옮겨도 될지 상의한다.</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_4" class="makeTdiv" style="width: 100%;">
			<h4>Q4. 아이가 다쳤을 때 어떤 순서대로 조치해야 할까요?</h4>
				<p>
					<input type="radio" id="q_4_a" name="quiz" class="quiz" value="0"><label for="q_4_a">망설이지 말고 단호히 거절한다.</label><br>
					<input type="radio" id="q_4_b" name="quiz" class="quiz" value="0"><label for="q_4_b">바로 회사로 연락해 도움을 요청한다.</label><br>
					<input type="radio" id="q_4_c" name="quiz" class="quiz" value="1"><label for="q_4_c">죄송하지만 등의 쿠션언어를 사용해 정중하고 부드럽게 거절한다.</label><br>
					<input type="radio" id="q_4_d" name="quiz" class="quiz" value="0"><label for="q_4_d">거절이 어려우므로 그냥 일단 요청대로 한다.</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_5" class="makeTdiv" style="width: 100%;">
			<h4>Q5. 돌봄 중 거절해도 되는 부모님의 요청사항은 어떤 것일까요?</h4>
				<p>
					<input type="radio" id="q_5_a" name="quiz" class="quiz" value="0"><label for="q_5_a">학교에서 온 아이 얼굴과 손발을 씻겨주세요.</label><br>
					<input type="radio" id="q_5_b" name="quiz" class="quiz" value="0"><label for="q_5_b">먹은 그릇을 씽크대에 넣어 주세요.</label><br>
					<input type="radio" id="q_5_c" name="quiz" class="quiz" value="0"><label for="q_5_c">선생님, 해놓은 김치볶음밥 렌지에 데워서 먹여주세요.</label><br>
					<input type="radio" id="q_5_d" name="quiz" class="quiz" value="1"><label for="q_5_d">선생님, 김치볶음밥 좀 요리해주세요.</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_6" class="makeTdiv" style="width: 100%;">
				...
				<p>
					<input type="radio" id="q_6_a" name="quiz" class="quiz" value="0"><label for="q_6_a">부모님께 인사</label><br>
					<input type="radio" id="q_6_b" name="quiz" class="quiz" value="0"><label for="q_6_b">집 안 구석구석 청소</label><br>
					<input type="radio" id="q_6_c" name="quiz" class="quiz" value="1"><label for="q_6_c">아이와 함께 뒷정리</label><br>
					<input type="radio" id="q_6_d" name="quiz" class="quiz" value="0"><label for="q_6_d">오늘 한 놀이 복습</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_7" class="makeTdiv" style="width: 100%;">
			<h4>Q7. 돌봄이 끝났는데 부모님이 안방에 계세요. 어떻게 해야할까요?</h4>
				<p>
					<input type="radio" id="q_7_a" name="quiz" class="quiz" value="0"><label for="q_7_a">부모님을 방해하지 않도록 인사없이 조용히 나온다.</label><br>
					<input type="radio" id="q_7_b" name="quiz" class="quiz" value="1"><label for="q_7_b">아이의 안전을 위해 돌봄시간이 끝났음을 알리고 인사한다.</label><br>
					<input type="radio" id="q_7_c" name="quiz" class="quiz" value="0"><label for="q_7_c">아이더러 안방에 들어가라고 하고 나온다.</label><br>
					<input type="radio" id="q_7_d" name="quiz" class="quiz" value="0"><label for="q_7_d">인사를 해도 되고 하지 않아도 된다.</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_8" class="makeTdiv" style="width: 100%;">
			<h4>Q8. 아이가 스마트폰을 보여달라고 졸라요. 어떻게 해야할까요?</h4>
				<p>
					<input type="radio" id="q_8_a" name="quiz" class="quiz" value="0"><label for="q_8_a">부모님께 바로 전화해서 보여줘도 되는지 묻는다.</label><br>
					<input type="radio" id="q_8_b" name="quiz" class="quiz" value="0"><label for="q_8_b">선생님은 보여줄 수 없다고 단호히 말하고 혼낸다.</label><br>
					<input type="radio" id="q_8_c" name="quiz" class="quiz" value="0"><label for="q_8_c">아이가 조르니까 일단 보여준다.</label><br>
					<input type="radio" id="q_8_d" name="quiz" class="quiz" value="1"><label for="q_8_d">아이의 마음에 공감해주면서 다른 놀이로 관심을 유도한다.</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_9" class="makeTdiv" style="width: 100%;">
			<h4>Q9. 위생적인 돌봄 필수사항이 아닌 것은 무엇인가요?</h4>
				<p>
					<input type="radio" id="q_9_a" name="quiz" class="quiz" value="1"><label for="q_9_a">향수</label><br>
					<input type="radio" id="q_9_b" name="quiz" class="quiz" value="0"><label for="q_9_b">양말</label><br>
					<input type="radio" id="q_9_c" name="quiz" class="quiz" value="0"><label for="q_9_c">손씻기</label><br>
					<input type="radio" id="q_9_d" name="quiz" class="quiz" value="0"><label for="q_9_d">마스크</label>
				</p>
			<div id="q_btn">
				<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
				<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
		...
		<div id="step_10" class="makeTdiv" style="width: 100%;">
			...
			<p>
				<input type="radio" id="q_10_a" name="quiz" class="quiz" value="0"><label for="q_10_a">부모님과 연락이 안되면 문자로 내용을 전달한 뒤 사준다.</label><br>
				<input type="radio" id="q_10_b" name="quiz" class="quiz" value="1"><label for="q_10_b">아이가 먹은거니, 부모님과 사전사후 연락을 하지 않아도 된다.</label><br>
				<input type="radio" id="q_10_c" name="quiz" class="quiz" value="0"><label for="q_10_c">아이가 조른다면 부모님에게 연락해 상의한다.</label><br>
				<input type="radio" id="q_10_d" name="quiz" class="quiz" value="0"><label for="q_10_d">추가된 비용을 돌봄 후 앱에 입력한다.</label>
			</p>
		<div id="q_btn">
			<button type="button" class="btn btn-secondary prevbtn" >이전으로</button>
			<button type="button" class="btn btn-secondary nextbtn" >다음으로</button>
  ...
  <script>
	...
	$(document).ready(function (){
			...
			$('.nextbtn').click(function (){
				if (!$('input[class=quiz]:checked').val()) {
