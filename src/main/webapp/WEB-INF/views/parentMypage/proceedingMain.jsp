...
<%@include file="/header.jsp" %>
   <div class="main">
         ...
         <!-- 현황버튼 -->
         <div class="btns">
            <div><button type="button" class="btn btn-outline-success" onclick="care_1();">요청 현황</button></div>
            <div><button type="button" class="btn btn-outline-success" onclick="care_2();">요청한 현황</button></div>
            <div><button type="button" class="btn btn-outline-success" onclick="care_3();">완료 현황</button></div>
		 </div>
